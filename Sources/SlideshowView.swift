...
@objc
public protocol SlideshowViewDataSource: NSObjectProtocol {
    
    @objc(numberOfItemsInSlideshowView:)
    func numberOfItems(in slideshowView: SlideshowView) -> Int
    
    @objc(slideshowView:cellForItemAtIndex:)
    func slideshowView(_ slideshowView: SlideshowView, cellForItemAt index: Int) -> UICollectionViewCell
    
}

@objc
public protocol SlideshowViewDelegate: NSObjectProtocol {
    
    @objc(slideshowView:shouldHighlightItemAtIndex:)
    optional func slideshowView(_ slideshowView: SlideshowView, shouldHighlightItemAt index: Int) -> Bool
    
    @objc(slideshowView:didHighlightItemAtIndex:)
    optional func slideshowView(_ slideshowView: SlideshowView, didHighlightItemAt index: Int)
    
    @objc(slideshowView:shouldSelectItemAtIndex:)
    optional func slideshowView(_ slideshowView: SlideshowView, shouldSelectItemAt index: Int) -> Bool
    
    @objc(slideshowView:didSelectItemAtIndex:)
    optional func slideshowView(_ slideshowView: SlideshowView, didSelectItemAt index: Int)
    
    @objc(slideshowView:willDisplayCell:forItemAtIndex:)
    optional func slideshowView(_ slideshowView: SlideshowView, willDisplay cell: UICollectionViewCell, forItemAt index: Int)
    
    @objc(slideshowView:didEndDisplayingCell:forItemAtIndex:)
    optional func slideshowView(_ slideshowView: SlideshowView, didEndDisplaying cell: UICollectionViewCell, forItemAt index: Int)
    
    @objc(slideshowViewWillBeginDragging:)
    optional func slideshowViewWillBeginDragging(_ slideshowView: SlideshowView)
    
    @objc(slideshowViewWillEndDragging:targetIndex:)
    optional func slideshowViewWillEndDragging(_ slideshowView: SlideshowView, targetIndex: Int)
    
    @objc(slideshowViewDidScroll:)
    optional func slideshowViewDidScroll(_ slideshowView: SlideshowView)
    
    @objc(slideshowViewDidEndScrollAnimation:)
    optional func slideshowViewDidEndScrollAnimation(_ slideshowView: SlideshowView)
    
    @objc(slideshowViewDidEndDecelerating:)
    optional func slideshowViewDidEndDecelerating(_ slideshowView: SlideshowView)
    
}

open class SlideshowView: UIView {
    
    @objc open weak var dataSource: SlideshowViewDataSource?
    
    @objc open weak var delegate: SlideshowViewDelegate?
    
    @objc open var scrollDirection: SlideshowLayout.ScrollDirection {
    ...
    private let collectionViewLayout = SlideshowLayout()
...
extension SlideshowView: UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = self.dataSource!.slideshowView(self, cellForItemAt: index)
        return cell
    }
    
    public func collectionView(_ collectionView: UICollectionView, shouldHighlightItemAt indexPath: IndexPath) -> Bool {
        self.delegate?.slideshowView?(self, shouldHighlightItemAt: indexPath.item) ?? true
    }
    
    public func collectionView(_ collectionView: UICollectionView, didHighlightItemAt indexPath: IndexPath) {
        self.delegate?.slideshowView?(self, didHighlightItemAt: indexPath.item)
    }
    
    public func collectionView(_ collectionView: UICollectionView, shouldSelectItemAt indexPath: IndexPath) -> Bool {
        self.delegate?.slideshowView?(self, shouldSelectItemAt: indexPath.item) ?? true
    }
    
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        self.delegate?.slideshowView?(self, didSelectItemAt: indexPath.item)
    }
    
    public func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        self.delegate?.slideshowView?(self, willDisplay: cell, forItemAt: indexPath.item)
    }
    
    public func collectionView(_ collectionView: UICollectionView, didEndDisplaying cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        self.delegate?.slideshowView?(self, didEndDisplaying: cell, forItemAt: indexPath.item)
    }
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        self.delegate?.slideshowViewDidScroll?(self)
    }
    
    public func scrollViewWillBeginDragging(_ scrollView: UIScrollView) {
        self.delegate?.slideshowViewWillBeginDragging?(self)
        if self.autoScrollTimeInterval > 0 {
            self.cancelTimer()
        }
    }
    ...
    public func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        if let function = self.delegate?.slideshowViewWillEndDragging(_:targetIndex:) {
    ...
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        self.delegate?.slideshowViewDidEndDecelerating?(self)
    }
    ...
    public func scrollViewDidEndScrollingAnimation(_ scrollView: UIScrollView) {
        ...
        self.delegate?.slideshowViewDidEndScrollAnimation?(self)
